...
允许过滤特定文明。由 [ModOptions.nationsToRemove](杂项 JSON 文件说明.md#modoptionsjson) 使用。
...
目前仅用于 [ModOptions.techsToRemove](杂项 JSON 文件说明.md#modoptionsjson)。
...
- 资源名称 - 来自 [TileResources.json](Mod 文件结构详解.md#tileresourcesjson)
